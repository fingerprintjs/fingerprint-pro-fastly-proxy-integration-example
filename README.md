...
You need to add two backends, `fpcdn.io` and `api.fpjs.io`. 
...
You need to provide the proxy secret and your chosen resource paths to the service.
...
7. After the validation is done, find your domain in the list of [Domains](https://manage.fastly.com/network/domains).
...
Wait a couple of minutes for the activation. You can go to `metrics.yourwebsite.com/status` to verify that your integration is up and running.

### 11. Configue the Fingerprint client agent to use your service
